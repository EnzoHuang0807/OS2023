...
void thrdstop_handler_resume_main_id(void *arg)
{
    ...
    thrdresume(main_id);  // jump to line 23
      ...
      10:	0a478793          	addi	a5,a5,164 # 20b0 <main_id>
      14:	439c                	lw	a5,0(a5)
      16:	853e                	mv	a0,a5
...
int test_multi_context()
{
    ...
    if (v2 == 77) {
      ...
      7c:	04878793          	addi	a5,a5,72 # 20c0 <v2.1>
      80:	439c                	lw	a5,0(a5)
      82:	873e                	mv	a4,a5
    ...
    v2 += 77;
      ...
      b2:	01278793          	addi	a5,a5,18 # 20c0 <v2.1>
      b6:	439c                	lw	a5,0(a5)
    ...
    while (v1 == 0) {
      ...
      f2:	fd678793          	addi	a5,a5,-42 # 20c4 <v1.0>
      f6:	439c                	lw	a5,0(a5)
...
int main(int argc, char **argv)
{
    ...
    fprintf(2, "[%s] %s\n", result ? "FAILED" : "OK", "test_multi_context");
     ...
     15e:	db678793          	addi	a5,a5,-586 # 1f10 <schedule_rm+0x2a6>
     162:	a029                	j	16c <main+0x3a>
     164:	00002797          	auipc	a5,0x2
     168:	db478793          	addi	a5,a5,-588 # 1f18 <schedule_rm+0x2ae>
     16c:	00002697          	auipc	a3,0x2
     170:	db468693          	addi	a3,a3,-588 # 1f20 <schedule_rm+0x2b6>
     174:	863e                	mv	a2,a5
     176:	00002597          	auipc	a1,0x2
     17a:	dc258593          	addi	a1,a1,-574 # 1f38 <schedule_rm+0x2ce>
     17e:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     78a:	8f268693          	addi	a3,a3,-1806 # 2078 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     864:	81870713          	addi	a4,a4,-2024 # 2078 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     a24:	52878793          	addi	a5,a5,1320 # 1f48 <schedule_rm+0x2de>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     bd0:	50c78793          	addi	a5,a5,1292 # 20d8 <freep>
     bd4:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     cc8:	41478793          	addi	a5,a5,1044 # 20d8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     d4a:	39278793          	addi	a5,a5,914 # 20d8 <freep>
     d4e:	639c                	ld	a5,0(a5)
}
     d50:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d7c:	36078793          	addi	a5,a5,864 # 20d8 <freep>
     d80:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d90:	33c78793          	addi	a5,a5,828 # 20c8 <base>
     d94:	fef43023          	sd	a5,-32(s0)
     d98:	00001797          	auipc	a5,0x1
     d9c:	34078793          	addi	a5,a5,832 # 20d8 <freep>
     da0:	fe043703          	ld	a4,-32(s0)
     da4:	e398                	sd	a4,0(a5)
     da6:	00001797          	auipc	a5,0x1
     daa:	33278793          	addi	a5,a5,818 # 20d8 <freep>
     dae:	6398                	ld	a4,0(a5)
     db0:	00001797          	auipc	a5,0x1
     db4:	31878793          	addi	a5,a5,792 # 20c8 <base>
     db8:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     dba:	00001797          	auipc	a5,0x1
     dbe:	30e78793          	addi	a5,a5,782 # 20c8 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     e3a:	2a278793          	addi	a5,a5,674 # 20d8 <freep>
    ...
    if(p == freep)
     ...
     e50:	28c78793          	addi	a5,a5,652 # 20d8 <freep>
     e54:	639c                	ld	a5,0(a5)
...
static inline void list_del(struct list_head *entry)
{
    ...
    entry->next = LIST_POISON1;
     ...
     fd8:	10070713          	addi	a4,a4,256 # 100100 <__global_pointer$+0xfd888>
     fdc:	e398                	sd	a4,0(a5)
    entry->prev = LIST_POISON2;
     fde:	fe843783          	ld	a5,-24(s0)
     fe2:	00200737          	lui	a4,0x200
     fe6:	20070713          	addi	a4,a4,512 # 200200 <__global_pointer$+0x1fd988>
     fea:	e798                	sd	a4,8(a5)
}
     fec:	0001                	nop
...
void thread_add_at(struct thread *t, int arrival_time)
{
    ...
    1148:	f5c58593          	addi	a1,a1,-164 # 20a0 <release_queue>
    114c:	853e                	mv	a0,a5
...
void __release()
{
    ...
    116c:	f3878793          	addi	a5,a5,-200 # 20a0 <release_queue>
    ...
    11a0:	f4c78793          	addi	a5,a5,-180 # 20e8 <threading_system_time>
    ...
    11e2:	eb258593          	addi	a1,a1,-334 # 2090 <run_queue>
    11e6:	853e                	mv	a0,a5
    ...
    1234:	e7078793          	addi	a5,a5,-400 # 20a0 <release_queue>
...
void __thread_exit(struct thread *to_remove)
{
    ...
    125e:	e8678793          	addi	a5,a5,-378 # 20e0 <current>
    ...
    12a6:	e1678793          	addi	a5,a5,-490 # 20b8 <main_thrd_id>
...
void thread_exit(void)
{
    ...
    12cc:	e1878793          	addi	a5,a5,-488 # 20e0 <current>
    12d0:	6398                	ld	a4,0(a5)
    12d2:	00001797          	auipc	a5,0x1
    12d6:	dbe78793          	addi	a5,a5,-578 # 2090 <run_queue>
    ...
    12e2:	c7258593          	addi	a1,a1,-910 # 1f50 <schedule_rm+0x2e6>
    12e6:	4509                	li	a0,2
    ...
    12fe:	de678793          	addi	a5,a5,-538 # 20e0 <current>
...
void __finish_current()
{
    ...
    1374:	d7078793          	addi	a5,a5,-656 # 20e0 <current>
    ...
    13a6:	d4678793          	addi	a5,a5,-698 # 20e8 <threading_system_time>
    ...
    13ba:	bd250513          	addi	a0,a0,-1070 # 1f88 <schedule_rm+0x31e>
...
void switch_handler(void *arg)
{
    ...
    1444:	ca078793          	addi	a5,a5,-864 # 20e0 <current>
    ...
    1466:	c8678793          	addi	a5,a5,-890 # 20e8 <threading_system_time>
    ...
    147a:	c7278793          	addi	a5,a5,-910 # 20e8 <threading_system_time>
    ...
    14b2:	c3a78793          	addi	a5,a5,-966 # 20e8 <threading_system_time>
    ...
    14c6:	c2678793          	addi	a5,a5,-986 # 20e8 <threading_system_time>
    ...
    14e4:	c0878793          	addi	a5,a5,-1016 # 20e8 <threading_system_time>
    14e8:	439c                	lw	a5,0(a5)
    14ea:	863e                	mv	a2,a5
    14ec:	85ba                	mv	a1,a4
    14ee:	00001517          	auipc	a0,0x1
    14f2:	ad250513          	addi	a0,a0,-1326 # 1fc0 <schedule_rm+0x356>
    ...
    1536:	b8678793          	addi	a5,a5,-1146 # 20b8 <main_thrd_id>
...
void __dispatch()
{
    ...
    155c:	b8878793          	addi	a5,a5,-1144 # 20e0 <current>
    1560:	6398                	ld	a4,0(a5)
    1562:	00001797          	auipc	a5,0x1
    1566:	b2e78793          	addi	a5,a5,-1234 # 2090 <run_queue>
    ...
    1572:	b7278793          	addi	a5,a5,-1166 # 20e0 <current>
    ...
    158c:	b6878793          	addi	a5,a5,-1176 # 20f0 <allocated_time>
    ...
    15a8:	a1c50513          	addi	a0,a0,-1508 # 1fc0 <schedule_rm+0x356>
    ...
    15c8:	b2478793          	addi	a5,a5,-1244 # 20e8 <threading_system_time>
    15cc:	4390                	lw	a2,0(a5)
    15ce:	00001797          	auipc	a5,0x1
    15d2:	b2278793          	addi	a5,a5,-1246 # 20f0 <allocated_time>
    15d6:	639c                	ld	a5,0(a5)
    15d8:	86be                	mv	a3,a5
    15da:	85ba                	mv	a1,a4
    15dc:	00001517          	auipc	a0,0x1
    15e0:	a0c50513          	addi	a0,a0,-1524 # 1fe8 <schedule_rm+0x37e>
    ...
    15f8:	afc78793          	addi	a5,a5,-1284 # 20f0 <allocated_time>
    ...
    160e:	ae678793          	addi	a5,a5,-1306 # 20f0 <allocated_time>
    ...
    1658:	a9c78793          	addi	a5,a5,-1380 # 20f0 <allocated_time>
    ...
    166e:	a8678793          	addi	a5,a5,-1402 # 20f0 <allocated_time>
    ...
    1696:	98658593          	addi	a1,a1,-1658 # 2018 <schedule_rm+0x3ae>
    169a:	4509                	li	a0,2
...
void __schedule(void)
{
    ...
    16e4:	a0878793          	addi	a5,a5,-1528 # 20e8 <threading_system_time>
    16e8:	439c                	lw	a5,0(a5)
    16ea:	fcf42c23          	sw	a5,-40(s0)
    16ee:	00001797          	auipc	a5,0x1
    16f2:	9a278793          	addi	a5,a5,-1630 # 2090 <run_queue>
    16f6:	fef43023          	sd	a5,-32(s0)
    16fa:	00001797          	auipc	a5,0x1
    16fe:	9a678793          	addi	a5,a5,-1626 # 20a0 <release_queue>
    ...
    1728:	546080e7          	jalr	1350(ra) # 1c6a <schedule_rm>
    172c:	872a                	mv	a4,a0
    172e:	87ae                	mv	a5,a1
...
void back_to_main_handler(void *arg)
{
    ...
    1770:	98078793          	addi	a5,a5,-1664 # 20ec <sleeping>
    ...
    1784:	96878793          	addi	a5,a5,-1688 # 20e8 <threading_system_time>
    ...
    1798:	95478793          	addi	a5,a5,-1708 # 20e8 <threading_system_time>
    179c:	c398                	sw	a4,0(a5)
    thrdresume(main_thrd_id);
    179e:	00001797          	auipc	a5,0x1
    17a2:	91a78793          	addi	a5,a5,-1766 # 20b8 <main_thrd_id>
...
void thread_start_threading()
{
    ...
    17c8:	92478793          	addi	a5,a5,-1756 # 20e8 <threading_system_time>
    17cc:	0007a023          	sw	zero,0(a5)
    current = &run_queue;
    17d0:	00001797          	auipc	a5,0x1
    17d4:	91078793          	addi	a5,a5,-1776 # 20e0 <current>
    17d8:	00001717          	auipc	a4,0x1
    17dc:	8b870713          	addi	a4,a4,-1864 # 2090 <run_queue>
    ...
    17f0:	8cc58593          	addi	a1,a1,-1844 # 20b8 <main_thrd_id>
    ...
    1804:	8b878793          	addi	a5,a5,-1864 # 20b8 <main_thrd_id>
    ...
    182c:	89078793          	addi	a5,a5,-1904 # 20b8 <main_thrd_id>
    ...
    184a:	84a50513          	addi	a0,a0,-1974 # 2090 <run_queue>
    ...
    185e:	84650513          	addi	a0,a0,-1978 # 20a0 <release_queue>
    ...
    1872:	88278793          	addi	a5,a5,-1918 # 20f0 <allocated_time>
    1876:	639c                	ld	a5,0(a5)
    1878:	85be                	mv	a1,a5
    187a:	00000517          	auipc	a0,0x0
    187e:	7d650513          	addi	a0,a0,2006 # 2050 <schedule_rm+0x3e6>
    1882:	fffff097          	auipc	ra,0xfffff
    1886:	2e6080e7          	jalr	742(ra) # b68 <printf>
        sleeping = 1;
    188a:	00001797          	auipc	a5,0x1
    188e:	86278793          	addi	a5,a5,-1950 # 20ec <sleeping>
    1892:	4705                	li	a4,1
    ...
    189a:	85a78793          	addi	a5,a5,-1958 # 20f0 <allocated_time>
    189e:	639c                	ld	a5,0(a5)
    18a0:	0007871b          	sext.w	a4,a5
    18a4:	00001797          	auipc	a5,0x1
    18a8:	84c78793          	addi	a5,a5,-1972 # 20f0 <allocated_time>
    ...
    18bc:	80058593          	addi	a1,a1,-2048 # 20b8 <main_thrd_id>
    18c0:	853a                	mv	a0,a4
    ...
    18f0:	7b450513          	addi	a0,a0,1972 # 20a0 <release_queue>
...
{
    19ce:	7175                	addi	sp,sp,-144
    19d0:	e522                	sd	s0,136(sp)
    19d2:	e126                	sd	s1,128(sp)
    19d4:	0900                	addi	s0,sp,144
    19d6:	84aa                	mv	s1,a0
    ...
    list_for_each_entry(th, args.run_queue, thread_list) {
    19e4:	649c                	ld	a5,8(s1)
    19e6:	639c                	ld	a5,0(a5)
    19e8:	faf43c23          	sd	a5,-72(s0)
    19ec:	fb843783          	ld	a5,-72(s0)
    19f0:	fd878793          	addi	a5,a5,-40
    19f4:	fcf43c23          	sd	a5,-40(s0)
    19f8:	a859                	j	1a8e <schedule_edf+0xc0>
        if (thread_edf == NULL || th -> current_deadline < thread_edf -> current_deadline || 
    19fa:	fe043783          	ld	a5,-32(s0)
    19fe:	cb8d                	beqz	a5,1a30 <schedule_edf+0x62>
    1a00:	fd843783          	ld	a5,-40(s0)
    1a04:	4bb8                	lw	a4,80(a5)
    1a06:	fe043783          	ld	a5,-32(s0)
    1a0a:	4bbc                	lw	a5,80(a5)
    1a0c:	02f74263          	blt	a4,a5,1a30 <schedule_edf+0x62>
	   (th -> current_deadline == thread_edf -> current_deadline && th -> ID < thread_edf -> ID)) {
    1a10:	fd843783          	ld	a5,-40(s0)
    1a14:	4bb8                	lw	a4,80(a5)
    1a16:	fe043783          	ld	a5,-32(s0)
    1a1a:	4bbc                	lw	a5,80(a5)
        if (thread_edf == NULL || th -> current_deadline < thread_edf -> current_deadline || 
    1a1c:	00f71e63          	bne	a4,a5,1a38 <schedule_edf+0x6a>
	   (th -> current_deadline == thread_edf -> current_deadline && th -> ID < thread_edf -> ID)) {
    1a20:	fd843783          	ld	a5,-40(s0)
    1a24:	5398                	lw	a4,32(a5)
    1a26:	fe043783          	ld	a5,-32(s0)
    1a2a:	539c                	lw	a5,32(a5)
    1a2c:	00f75663          	bge	a4,a5,1a38 <schedule_edf+0x6a>
            thread_edf = th;
    1a30:	fd843783          	ld	a5,-40(s0)
    ...
    1a3a:	fd843783          	ld	a5,-40(s0)
    1a3e:	4bbc                	lw	a5,80(a5)
    1a40:	00e7cd63          	blt	a5,a4,1a5a <schedule_edf+0x8c>
	   (args.current_time == th -> current_deadline && th -> remaining_time > 0)){
    1a44:	4098                	lw	a4,0(s1)
    1a46:	fd843783          	ld	a5,-40(s0)
    1a4a:	4bbc                	lw	a5,80(a5)
	if (args.current_time > th -> current_deadline ||
    1a4c:	02f71663          	bne	a4,a5,1a78 <schedule_edf+0xaa>
	   (args.current_time == th -> current_deadline && th -> remaining_time > 0)){
    1a50:	fd843783          	ld	a5,-40(s0)
    1a54:	47fc                	lw	a5,76(a5)
    1a56:	02f05163          	blez	a5,1a78 <schedule_edf+0xaa>
           if (thread_deadline == NULL || th -> ID < thread_deadline -> ID)
    1a5a:	fe843783          	ld	a5,-24(s0)
    1a5e:	cb89                	beqz	a5,1a70 <schedule_edf+0xa2>
    1a60:	fd843783          	ld	a5,-40(s0)
    1a64:	5398                	lw	a4,32(a5)
    1a66:	fe843783          	ld	a5,-24(s0)
    1a6a:	539c                	lw	a5,32(a5)
    1a6c:	00f75663          	bge	a4,a5,1a78 <schedule_edf+0xaa>
	     thread_deadline = th;
    1a70:	fd843783          	ld	a5,-40(s0)
    1a74:	fef43423          	sd	a5,-24(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1a78:	fd843783          	ld	a5,-40(s0)
    1a7c:	779c                	ld	a5,40(a5)
    1a7e:	faf43023          	sd	a5,-96(s0)
    1a82:	fa043783          	ld	a5,-96(s0)
    1a86:	fd878793          	addi	a5,a5,-40
    1a8a:	fcf43c23          	sd	a5,-40(s0)
    1a8e:	fd843783          	ld	a5,-40(s0)
    1a92:	02878713          	addi	a4,a5,40
    1a96:	649c                	ld	a5,8(s1)
    1a98:	f6f711e3          	bne	a4,a5,19fa <schedule_edf+0x2c>
	}
    }

    if (thread_deadline != NULL){
    1a9c:	fe843783          	ld	a5,-24(s0)
    1aa0:	c395                	beqz	a5,1ac4 <schedule_edf+0xf6>
      struct threads_sched_result r;
      r.scheduled_thread_list_member = &thread_deadline -> thread_list;
    1aa2:	fe843783          	ld	a5,-24(s0)
    1aa6:	02878793          	addi	a5,a5,40
    1aaa:	f6f43823          	sd	a5,-144(s0)
      r.allocated_time = 0;
    1aae:	f6042c23          	sw	zero,-136(s0)
      return r;
    1ab2:	f7043783          	ld	a5,-144(s0)
    1ab6:	f8f43823          	sd	a5,-112(s0)
    1aba:	f7843783          	ld	a5,-136(s0)
    1abe:	f8f43c23          	sd	a5,-104(s0)
    1ac2:	a271                	j	1c4e <schedule_edf+0x280>
    //debug message
    ...
    1ac4:	fc043823          	sd	zero,-48(s0)
    struct release_queue_entry * entry_preempt = NULL;
    1ac8:	fc043423          	sd	zero,-56(s0)
    struct release_queue_entry * ent = NULL;
    1acc:	fc043023          	sd	zero,-64(s0)
    list_for_each_entry(ent, args.release_queue, thread_list){
    1ad0:	689c                	ld	a5,16(s1)
    1ad2:	639c                	ld	a5,0(a5)
    1ad4:	faf43823          	sd	a5,-80(s0)
    1ad8:	fb043783          	ld	a5,-80(s0)
    1adc:	17e1                	addi	a5,a5,-8
    1ade:	fcf43023          	sd	a5,-64(s0)
    1ae2:	a87d                	j	1ba0 <schedule_edf+0x1d2>

        if (next == NULL || ent -> release_time < next -> release_time || 
    1ae4:	fd043783          	ld	a5,-48(s0)
    1ae8:	cb9d                	beqz	a5,1b1e <schedule_edf+0x150>
    1aea:	fc043783          	ld	a5,-64(s0)
    1aee:	4f98                	lw	a4,24(a5)
    1af0:	fd043783          	ld	a5,-48(s0)
    1af4:	4f9c                	lw	a5,24(a5)
    1af6:	02f74463          	blt	a4,a5,1b1e <schedule_edf+0x150>
	    (ent -> release_time == next -> release_time && ent -> thrd -> ID < next -> thrd -> ID))
    1afa:	fc043783          	ld	a5,-64(s0)
    1afe:	4f98                	lw	a4,24(a5)
    1b00:	fd043783          	ld	a5,-48(s0)
    1b04:	4f9c                	lw	a5,24(a5)
        if (next == NULL || ent -> release_time < next -> release_time || 
    1b06:	02f71063          	bne	a4,a5,1b26 <schedule_edf+0x158>
	    (ent -> release_time == next -> release_time && ent -> thrd -> ID < next -> thrd -> ID))
    1b0a:	fc043783          	ld	a5,-64(s0)
    1b0e:	639c                	ld	a5,0(a5)
    1b10:	5398                	lw	a4,32(a5)
    1b12:	fd043783          	ld	a5,-48(s0)
    1b16:	639c                	ld	a5,0(a5)
    1b18:	539c                	lw	a5,32(a5)
    1b1a:	00f75663          	bge	a4,a5,1b26 <schedule_edf+0x158>
          next = ent;
    1b1e:	fc043783          	ld	a5,-64(s0)
    1b22:	fcf43823          	sd	a5,-48(s0)

        if (thread_edf != NULL && ent -> release_time + ent -> thrd -> period < thread_edf -> current_deadline) {
    1b26:	fe043783          	ld	a5,-32(s0)
    1b2a:	c3ad                	beqz	a5,1b8c <schedule_edf+0x1be>
    1b2c:	fc043783          	ld	a5,-64(s0)
    1b30:	4f98                	lw	a4,24(a5)
    1b32:	fc043783          	ld	a5,-64(s0)
    1b36:	639c                	ld	a5,0(a5)
    1b38:	43fc                	lw	a5,68(a5)
    1b3a:	9fb9                	addw	a5,a5,a4
    1b3c:	0007871b          	sext.w	a4,a5
    1b40:	fe043783          	ld	a5,-32(s0)
    1b44:	4bbc                	lw	a5,80(a5)
    1b46:	04f75363          	bge	a4,a5,1b8c <schedule_edf+0x1be>
	  if (entry_preempt == NULL || ent -> release_time < entry_preempt -> release_time ||
    1b4a:	fc843783          	ld	a5,-56(s0)
    1b4e:	cb9d                	beqz	a5,1b84 <schedule_edf+0x1b6>
    1b50:	fc043783          	ld	a5,-64(s0)
    1b54:	4f98                	lw	a4,24(a5)
    1b56:	fc843783          	ld	a5,-56(s0)
    1b5a:	4f9c                	lw	a5,24(a5)
    1b5c:	02f74463          	blt	a4,a5,1b84 <schedule_edf+0x1b6>
	      (ent -> release_time == entry_preempt -> release_time && 
    1b60:	fc043783          	ld	a5,-64(s0)
    1b64:	4f98                	lw	a4,24(a5)
    1b66:	fc843783          	ld	a5,-56(s0)
    1b6a:	4f9c                	lw	a5,24(a5)
	  if (entry_preempt == NULL || ent -> release_time < entry_preempt -> release_time ||
    1b6c:	02f71063          	bne	a4,a5,1b8c <schedule_edf+0x1be>
	       ent -> thrd -> ID < entry_preempt -> thrd -> ID))
    1b70:	fc043783          	ld	a5,-64(s0)
    1b74:	639c                	ld	a5,0(a5)
    1b76:	5398                	lw	a4,32(a5)
    1b78:	fc843783          	ld	a5,-56(s0)
    1b7c:	639c                	ld	a5,0(a5)
    1b7e:	539c                	lw	a5,32(a5)
	      (ent -> release_time == entry_preempt -> release_time && 
    1b80:	00f75663          	bge	a4,a5,1b8c <schedule_edf+0x1be>
            entry_preempt = ent;
    1b84:	fc043783          	ld	a5,-64(s0)
    1b88:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(ent, args.release_queue, thread_list){
    1b8c:	fc043783          	ld	a5,-64(s0)
    1b90:	679c                	ld	a5,8(a5)
    1b92:	faf43423          	sd	a5,-88(s0)
    1b96:	fa843783          	ld	a5,-88(s0)
    1b9a:	17e1                	addi	a5,a5,-8
    1b9c:	fcf43023          	sd	a5,-64(s0)
    1ba0:	fc043783          	ld	a5,-64(s0)
    1ba4:	00878713          	addi	a4,a5,8
    1ba8:	689c                	ld	a5,16(s1)
    1baa:	f2f71de3          	bne	a4,a5,1ae4 <schedule_edf+0x116>
        }
    }

    struct threads_sched_result r;
    if (thread_edf != NULL) {
    1bae:	fe043783          	ld	a5,-32(s0)
    1bb2:	cbb5                	beqz	a5,1c26 <schedule_edf+0x258>
        r.scheduled_thread_list_member = &thread_edf -> thread_list;
    1bb4:	fe043783          	ld	a5,-32(s0)
    1bb8:	02878793          	addi	a5,a5,40
    1bbc:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = thread_edf -> remaining_time;
    1bc0:	fe043783          	ld	a5,-32(s0)
    1bc4:	47fc                	lw	a5,76(a5)
    1bc6:	f8f42423          	sw	a5,-120(s0)

	if (r.allocated_time > thread_edf -> current_deadline - args.current_time){
    1bca:	f8842583          	lw	a1,-120(s0)
    1bce:	fe043783          	ld	a5,-32(s0)
    1bd2:	4bb8                	lw	a4,80(a5)
    1bd4:	409c                	lw	a5,0(s1)
    1bd6:	40f707bb          	subw	a5,a4,a5
    1bda:	2781                	sext.w	a5,a5
    1bdc:	872e                	mv	a4,a1
    1bde:	00e7db63          	bge	a5,a4,1bf4 <schedule_edf+0x226>
    ...
    1be6:	4bb8                	lw	a4,80(a5)
    1be8:	409c                	lw	a5,0(s1)
    1bea:	40f707bb          	subw	a5,a4,a5
    1bee:	2781                	sext.w	a5,a5
    1bf0:	f8f42423          	sw	a5,-120(s0)
	}
	if(entry_preempt != NULL && 
    1bf4:	fc843783          	ld	a5,-56(s0)
    1bf8:	c3b9                	beqz	a5,1c3e <schedule_edf+0x270>
	    r.allocated_time > entry_preempt -> release_time - args.current_time){
    1bfa:	f8842583          	lw	a1,-120(s0)
    1bfe:	fc843783          	ld	a5,-56(s0)
    1c02:	4f98                	lw	a4,24(a5)
    1c04:	409c                	lw	a5,0(s1)
    1c06:	40f707bb          	subw	a5,a4,a5
    1c0a:	2781                	sext.w	a5,a5
	if(entry_preempt != NULL && 
    1c0c:	872e                	mv	a4,a1
    1c0e:	02e7d863          	bge	a5,a4,1c3e <schedule_edf+0x270>
	  // some thread will be released later but have eairlier deadline
	  r.allocated_time = entry_preempt -> release_time - args.current_time;
    1c12:	fc843783          	ld	a5,-56(s0)
    1c16:	4f98                	lw	a4,24(a5)
    1c18:	409c                	lw	a5,0(s1)
    1c1a:	40f707bb          	subw	a5,a4,a5
    1c1e:	2781                	sext.w	a5,a5
    1c20:	f8f42423          	sw	a5,-120(s0)
    1c24:	a829                	j	1c3e <schedule_edf+0x270>
	}
    } 
    else {
        r.scheduled_thread_list_member = args.run_queue;
    1c26:	649c                	ld	a5,8(s1)
    1c28:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = next -> release_time - args.current_time;
    1c2c:	fd043783          	ld	a5,-48(s0)
    1c30:	4f98                	lw	a4,24(a5)
    1c32:	409c                	lw	a5,0(s1)
    1c34:	40f707bb          	subw	a5,a4,a5
    1c38:	2781                	sext.w	a5,a5
    1c3a:	f8f42423          	sw	a5,-120(s0)
    }

    return r;
    1c3e:	f8043783          	ld	a5,-128(s0)
    1c42:	f8f43823          	sd	a5,-112(s0)
    1c46:	f8843783          	ld	a5,-120(s0)
    1c4a:	f8f43c23          	sd	a5,-104(s0)
}
    1c4e:	f9043703          	ld	a4,-112(s0)
    1c52:	f9843783          	ld	a5,-104(s0)
    1c56:	863a                	mv	a2,a4
    1c58:	86be                	mv	a3,a5
    1c5a:	8732                	mv	a4,a2
    1c5c:	87b6                	mv	a5,a3
    1c5e:	853a                	mv	a0,a4
    1c60:	85be                	mv	a1,a5
    1c62:	642a                	ld	s0,136(sp)
    1c64:	648a                	ld	s1,128(sp)
    1c66:	6149                	addi	sp,sp,144
    1c68:	8082                	ret

0000000000001c6a <schedule_rm>:

/* Rate-Monotonic Scheduling */
struct threads_sched_result schedule_rm(struct threads_sched_args args)
{
    1c6a:	7175                	addi	sp,sp,-144
    1c6c:	e522                	sd	s0,136(sp)
    1c6e:	e126                	sd	s1,128(sp)
    1c70:	0900                	addi	s0,sp,144
    1c72:	84aa                	mv	s1,a0
    struct thread * thread_deadline = NULL;
    1c74:	fe043423          	sd	zero,-24(s0)
    struct thread * thread_rm = NULL;
    1c78:	fe043023          	sd	zero,-32(s0)
    struct thread * th = NULL;
    1c7c:	fc043c23          	sd	zero,-40(s0)

    list_for_each_entry(th, args.run_queue, thread_list) {
    1c80:	649c                	ld	a5,8(s1)
    1c82:	639c                	ld	a5,0(a5)
    1c84:	faf43c23          	sd	a5,-72(s0)
    1c88:	fb843783          	ld	a5,-72(s0)
    1c8c:	fd878793          	addi	a5,a5,-40
    1c90:	fcf43c23          	sd	a5,-40(s0)
    1c94:	a859                	j	1d2a <schedule_rm+0xc0>
        if (thread_rm == NULL || th -> period < thread_rm -> period || 
    1c96:	fe043783          	ld	a5,-32(s0)
    1c9a:	cb8d                	beqz	a5,1ccc <schedule_rm+0x62>
    1c9c:	fd843783          	ld	a5,-40(s0)
    1ca0:	43f8                	lw	a4,68(a5)
    1ca2:	fe043783          	ld	a5,-32(s0)
    1ca6:	43fc                	lw	a5,68(a5)
    1ca8:	02f74263          	blt	a4,a5,1ccc <schedule_rm+0x62>
	   (th -> period == thread_rm -> period && th -> ID < thread_rm -> ID)) {
    1cac:	fd843783          	ld	a5,-40(s0)
    1cb0:	43f8                	lw	a4,68(a5)
    1cb2:	fe043783          	ld	a5,-32(s0)
    1cb6:	43fc                	lw	a5,68(a5)
        if (thread_rm == NULL || th -> period < thread_rm -> period || 
    1cb8:	00f71e63          	bne	a4,a5,1cd4 <schedule_rm+0x6a>
	   (th -> period == thread_rm -> period && th -> ID < thread_rm -> ID)) {
    1cbc:	fd843783          	ld	a5,-40(s0)
    1cc0:	5398                	lw	a4,32(a5)
    1cc2:	fe043783          	ld	a5,-32(s0)
    1cc6:	539c                	lw	a5,32(a5)
    1cc8:	00f75663          	bge	a4,a5,1cd4 <schedule_rm+0x6a>
            thread_rm = th;
    ...
    1cda:	4bbc                	lw	a5,80(a5)
    1cdc:	00e7cd63          	blt	a5,a4,1cf6 <schedule_rm+0x8c>
	   (args.current_time == th -> current_deadline && th -> remaining_time > 0)){
    1ce0:	4098                	lw	a4,0(s1)
    1ce2:	fd843783          	ld	a5,-40(s0)
    1ce6:	4bbc                	lw	a5,80(a5)
	if (args.current_time > th -> current_deadline ||
    1ce8:	02f71663          	bne	a4,a5,1d14 <schedule_rm+0xaa>
	   (args.current_time == th -> current_deadline && th -> remaining_time > 0)){
    1cec:	fd843783          	ld	a5,-40(s0)
    1cf0:	47fc                	lw	a5,76(a5)
    1cf2:	02f05163          	blez	a5,1d14 <schedule_rm+0xaa>
           if (thread_deadline == NULL || th -> ID < thread_deadline -> ID)
    1cf6:	fe843783          	ld	a5,-24(s0)
    1cfa:	cb89                	beqz	a5,1d0c <schedule_rm+0xa2>
    1cfc:	fd843783          	ld	a5,-40(s0)
    1d00:	5398                	lw	a4,32(a5)
    1d02:	fe843783          	ld	a5,-24(s0)
    1d06:	539c                	lw	a5,32(a5)
    1d08:	00f75663          	bge	a4,a5,1d14 <schedule_rm+0xaa>
	     thread_deadline = th;
    1d0c:	fd843783          	ld	a5,-40(s0)
    1d10:	fef43423          	sd	a5,-24(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1d14:	fd843783          	ld	a5,-40(s0)
    1d18:	779c                	ld	a5,40(a5)
    1d1a:	faf43023          	sd	a5,-96(s0)
    1d1e:	fa043783          	ld	a5,-96(s0)
    1d22:	fd878793          	addi	a5,a5,-40
    1d26:	fcf43c23          	sd	a5,-40(s0)
    1d2a:	fd843783          	ld	a5,-40(s0)
    1d2e:	02878713          	addi	a4,a5,40
    1d32:	649c                	ld	a5,8(s1)
    1d34:	f6f711e3          	bne	a4,a5,1c96 <schedule_rm+0x2c>
	}
    }

    if (thread_deadline != NULL){
    1d38:	fe843783          	ld	a5,-24(s0)
    1d3c:	c395                	beqz	a5,1d60 <schedule_rm+0xf6>
      struct threads_sched_result r;
      r.scheduled_thread_list_member = &thread_deadline -> thread_list;
    ...
    1d46:	f6f43823          	sd	a5,-144(s0)
      r.allocated_time = 0;
    1d4a:	f6042c23          	sw	zero,-136(s0)
      return r;
    1d4e:	f7043783          	ld	a5,-144(s0)
    1d52:	f8f43823          	sd	a5,-112(s0)
    1d56:	f7843783          	ld	a5,-136(s0)
    1d5a:	f8f43c23          	sd	a5,-104(s0)
    1d5e:	aa41                	j	1eee <schedule_rm+0x284>
    //debug message
    //printf("current time: %d\n", args.current_time); 
    //printf("thread id = %d\n", thread_edf -> ID);
    ...
    struct release_queue_entry * next = NULL;
    1d60:	fc043823          	sd	zero,-48(s0)
    struct release_queue_entry * entry_preempt = NULL;
    1d64:	fc043423          	sd	zero,-56(s0)
    struct release_queue_entry * ent = NULL;
    1d68:	fc043023          	sd	zero,-64(s0)
    list_for_each_entry(ent, args.release_queue, thread_list){
    1d6c:	689c                	ld	a5,16(s1)
    1d6e:	639c                	ld	a5,0(a5)
    1d70:	faf43823          	sd	a5,-80(s0)
    1d74:	fb043783          	ld	a5,-80(s0)
    1d78:	17e1                	addi	a5,a5,-8
    1d7a:	fcf43023          	sd	a5,-64(s0)
    1d7e:	a0c9                	j	1e40 <schedule_rm+0x1d6>

        if (next == NULL || ent -> release_time < next -> release_time || 
    1d80:	fd043783          	ld	a5,-48(s0)
    1d84:	cb9d                	beqz	a5,1dba <schedule_rm+0x150>
    1d86:	fc043783          	ld	a5,-64(s0)
    1d8a:	4f98                	lw	a4,24(a5)
    1d8c:	fd043783          	ld	a5,-48(s0)
    1d90:	4f9c                	lw	a5,24(a5)
    1d92:	02f74463          	blt	a4,a5,1dba <schedule_rm+0x150>
	    (ent -> release_time == next -> release_time && ent -> thrd -> ID < next -> thrd -> ID))
    1d96:	fc043783          	ld	a5,-64(s0)
    1d9a:	4f98                	lw	a4,24(a5)
    1d9c:	fd043783          	ld	a5,-48(s0)
    1da0:	4f9c                	lw	a5,24(a5)
        if (next == NULL || ent -> release_time < next -> release_time || 
    1da2:	02f71063          	bne	a4,a5,1dc2 <schedule_rm+0x158>
	    (ent -> release_time == next -> release_time && ent -> thrd -> ID < next -> thrd -> ID))
    1da6:	fc043783          	ld	a5,-64(s0)
    1daa:	639c                	ld	a5,0(a5)
    1dac:	5398                	lw	a4,32(a5)
    1dae:	fd043783          	ld	a5,-48(s0)
    1db2:	639c                	ld	a5,0(a5)
    1db4:	539c                	lw	a5,32(a5)
    1db6:	00f75663          	bge	a4,a5,1dc2 <schedule_rm+0x158>
          next = ent;
    1dba:	fc043783          	ld	a5,-64(s0)
    1dbe:	fcf43823          	sd	a5,-48(s0)

        if (thread_rm != NULL && ent -> release_time < thread_rm -> current_deadline && 
    1dc2:	fe043783          	ld	a5,-32(s0)
    1dc6:	c3bd                	beqz	a5,1e2c <schedule_rm+0x1c2>
    1dc8:	fc043783          	ld	a5,-64(s0)
    1dcc:	4f98                	lw	a4,24(a5)
    1dce:	fe043783          	ld	a5,-32(s0)
    1dd2:	4bbc                	lw	a5,80(a5)
    1dd4:	04f75c63          	bge	a4,a5,1e2c <schedule_rm+0x1c2>
	    ent -> thrd -> period < thread_rm  -> period) {
    1dd8:	fc043783          	ld	a5,-64(s0)
    1ddc:	639c                	ld	a5,0(a5)
    1dde:	43f8                	lw	a4,68(a5)
    1de0:	fe043783          	ld	a5,-32(s0)
    1de4:	43fc                	lw	a5,68(a5)
        if (thread_rm != NULL && ent -> release_time < thread_rm -> current_deadline && 
    1de6:	04f75363          	bge	a4,a5,1e2c <schedule_rm+0x1c2>

	  if (entry_preempt == NULL || ent -> release_time < entry_preempt -> release_time ||
    1dea:	fc843783          	ld	a5,-56(s0)
    1dee:	cb9d                	beqz	a5,1e24 <schedule_rm+0x1ba>
    1df0:	fc043783          	ld	a5,-64(s0)
    1df4:	4f98                	lw	a4,24(a5)
    1df6:	fc843783          	ld	a5,-56(s0)
    1dfa:	4f9c                	lw	a5,24(a5)
    1dfc:	02f74463          	blt	a4,a5,1e24 <schedule_rm+0x1ba>
	      (ent -> release_time == entry_preempt -> release_time && 
    1e00:	fc043783          	ld	a5,-64(s0)
    1e04:	4f98                	lw	a4,24(a5)
    1e06:	fc843783          	ld	a5,-56(s0)
    1e0a:	4f9c                	lw	a5,24(a5)
	  if (entry_preempt == NULL || ent -> release_time < entry_preempt -> release_time ||
    1e0c:	02f71063          	bne	a4,a5,1e2c <schedule_rm+0x1c2>
	       ent -> thrd -> ID < entry_preempt -> thrd -> ID))
    1e10:	fc043783          	ld	a5,-64(s0)
    1e14:	639c                	ld	a5,0(a5)
    1e16:	5398                	lw	a4,32(a5)
    1e18:	fc843783          	ld	a5,-56(s0)
    1e1c:	639c                	ld	a5,0(a5)
    1e1e:	539c                	lw	a5,32(a5)
	      (ent -> release_time == entry_preempt -> release_time && 
    1e20:	00f75663          	bge	a4,a5,1e2c <schedule_rm+0x1c2>
            entry_preempt = ent;
    1e24:	fc043783          	ld	a5,-64(s0)
    1e28:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(ent, args.release_queue, thread_list){
    1e2c:	fc043783          	ld	a5,-64(s0)
    1e30:	679c                	ld	a5,8(a5)
    1e32:	faf43423          	sd	a5,-88(s0)
    1e36:	fa843783          	ld	a5,-88(s0)
    1e3a:	17e1                	addi	a5,a5,-8
    1e3c:	fcf43023          	sd	a5,-64(s0)
    1e40:	fc043783          	ld	a5,-64(s0)
    1e44:	00878713          	addi	a4,a5,8
    1e48:	689c                	ld	a5,16(s1)
    1e4a:	f2f71be3          	bne	a4,a5,1d80 <schedule_rm+0x116>
        }
    }

    struct threads_sched_result r;
    if (thread_rm != NULL) {
    1e4e:	fe043783          	ld	a5,-32(s0)
    1e52:	cbb5                	beqz	a5,1ec6 <schedule_rm+0x25c>
        r.scheduled_thread_list_member = &thread_rm -> thread_list;
    1e54:	fe043783          	ld	a5,-32(s0)
    1e58:	02878793          	addi	a5,a5,40
    1e5c:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = thread_rm -> remaining_time;
    1e60:	fe043783          	ld	a5,-32(s0)
    1e64:	47fc                	lw	a5,76(a5)
    1e66:	f8f42423          	sw	a5,-120(s0)

	if (r.allocated_time > thread_rm -> current_deadline - args.current_time){
    1e6a:	f8842583          	lw	a1,-120(s0)
    1e6e:	fe043783          	ld	a5,-32(s0)
    1e72:	4bb8                	lw	a4,80(a5)
    1e74:	409c                	lw	a5,0(s1)
    1e76:	40f707bb          	subw	a5,a4,a5
    1e7a:	2781                	sext.w	a5,a5
    1e7c:	872e                	mv	a4,a1
    1e7e:	00e7db63          	bge	a5,a4,1e94 <schedule_rm+0x22a>
	  // current thread terminated by own deadline
	  r.allocated_time = thread_rm -> current_deadline - args.current_time;
    1e82:	fe043783          	ld	a5,-32(s0)
    1e86:	4bb8                	lw	a4,80(a5)
    1e88:	409c                	lw	a5,0(s1)
    1e8a:	40f707bb          	subw	a5,a4,a5
    1e8e:	2781                	sext.w	a5,a5
    1e90:	f8f42423          	sw	a5,-120(s0)
	}
	if(entry_preempt != NULL && 
    1e94:	fc843783          	ld	a5,-56(s0)
    1e98:	c3b9                	beqz	a5,1ede <schedule_rm+0x274>
	    r.allocated_time > entry_preempt -> release_time - args.current_time){
    1e9a:	f8842583          	lw	a1,-120(s0)
    1e9e:	fc843783          	ld	a5,-56(s0)
    1ea2:	4f98                	lw	a4,24(a5)
    1ea4:	409c                	lw	a5,0(s1)
    1ea6:	40f707bb          	subw	a5,a4,a5
    1eaa:	2781                	sext.w	a5,a5
	if(entry_preempt != NULL && 
    1eac:	872e                	mv	a4,a1
    1eae:	02e7d863          	bge	a5,a4,1ede <schedule_rm+0x274>
	  // some thread will be released later but have eairlier deadline
	  r.allocated_time = entry_preempt -> release_time - args.current_time;
    1eb2:	fc843783          	ld	a5,-56(s0)
    1eb6:	4f98                	lw	a4,24(a5)
    1eb8:	409c                	lw	a5,0(s1)
    1eba:	40f707bb          	subw	a5,a4,a5
    1ebe:	2781                	sext.w	a5,a5
    1ec0:	f8f42423          	sw	a5,-120(s0)
    1ec4:	a829                	j	1ede <schedule_rm+0x274>
	}
    } 
    else {
        r.scheduled_thread_list_member = args.run_queue;
    1ec6:	649c                	ld	a5,8(s1)
    1ec8:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = next -> release_time - args.current_time;
    1ecc:	fd043783          	ld	a5,-48(s0)
    1ed0:	4f98                	lw	a4,24(a5)
    ...
    1efe:	853a                	mv	a0,a4
    1f00:	85be                	mv	a1,a5
    1f02:	642a                	ld	s0,136(sp)
    1f04:	648a                	ld	s1,128(sp)
    1f06:	6149                	addi	sp,sp,144
    1f08:	8082                	ret
